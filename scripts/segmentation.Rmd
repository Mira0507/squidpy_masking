...
sq.im.segment(img=img, layer=lyr_smth, method=seg_method, thresh=thr_method, channel=0)
# sq.im.segment(img=img, layer=lyr_smth, method=seg_method, thresh=thr_method, channel=1)
# sq.im.segment(img=img, layer=lyr_smth, method=seg_method, thresh=thr_method, channel=2)
```
