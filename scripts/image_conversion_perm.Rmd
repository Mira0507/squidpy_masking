...
vsi = "../images/input/Perm/Image_168.vsi"

# Specify the path to output directory
output_dir = "image_conversion_perm"
os.makedirs(output_dir, exist_ok=True)

# Specify the path to output tif file
tif = f"{output_dir}/converted_168.ome.tif"

# Specify the path to metadata
input_meta_out = f"{output_dir}/input_metadata_168.txt"
output_meta_out = f"{output_dir}/output_metadata_168.txt"
