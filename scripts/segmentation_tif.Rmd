...
def image_original_processed(l_one, l_two, image, channel, process):
    # Design subplots
    fig, axes = plt.subplots(nrows=1, ncols=2)
    image.show(layer=l_one, channel=channel, cmap='gray', ax=axes[0])
    _ = axes[0].set_title(f"Original before {process}")
    image.show(layer=l_two, channel=channel, cmap='gray', ax=axes[1])
