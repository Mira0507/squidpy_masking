...
```{r params}
params = list(
            outdir = "results/noperm",
            input_obj = "results/noperm/otsu_thresholding.zarr",
            output_obj = "results/noperm/adaptive_thresholding.zarr",
            conda_env = "../../env",
            chunksize = "5000",
            lyr = "image",
            block_size = "None")
