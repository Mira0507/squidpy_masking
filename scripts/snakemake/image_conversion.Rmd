...
```{r params}
############################# DELETE #############################
params <- list(vsi = "../../images/input/Perm/Image_168.vsi",
               tif = "../../images/converted/perm/converted.ome.tif",
               input_meta_out = "../../images/converted/perm/input_metadata.txt",
               output_meta_out = "../../images/converted/perm/output_metadata.txt",
               ser = "None",
               conda_env = "../../env",
               to_pyramidal = "Y")
##################################################################
...
to_pyramidal <- params[['to_pyramidal']]
ser <- params[['ser']]
```
