...
# ------------------------------------------------------------------------------
# This chunk sets up a function to create intensity histogram
# ------------------------------------------------------------------------------
...
for (i in 1:py$img[[py$lyr]][['shape']][[4]]) {
    ...
    t_deparsed_1 <- paste0("intensity_histogram(layer='", py$lyr, "', channel=", i, ")")
    t_deparsed_2 <- paste0("plt.savefig('", py$outdir, "/inputhist_channel_", i,  ".png')")
    t_deparsed <- c(t_deparsed_1, t_deparsed_2)
    subchunkify(name=paste0("inputhist_", i), t_deparsed=t_deparsed)

    save_path <- paste0(py$outdir, "/inputhistnorm_channel_", i, ".png")
    link_output(paste0("inputhistnorm_channel_", i, ".png"))
